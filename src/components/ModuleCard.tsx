...
export const moduleCards: ModuleCardData[] = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "Shartnomalar soni", value: "21 450", trend: "up", trendValue: "+6.3%" },
  ...
  },
  {
    ...
    mainValue: "27 800",
    mainLabel: "talaba",
    sparkline: [2100, 2340, 2500, 2700, 2780, 2850],
    metrics: [
      { label: "Jami to'lanadigan summa", value: "4 500 mlrd" },
      { label: "Shartnomalar soni", value: "31 200", trend: "up", trendValue: "+7.1%" },
